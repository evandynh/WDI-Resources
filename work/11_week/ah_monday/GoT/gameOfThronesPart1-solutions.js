...
//     User the function created above to print a hail to our king on the console!
...
// 1.  Create an array called `kings` and push our king from Chapter 1 into it...
...
kings.push("Joffrey");
console.log(hailTo(kings[1]));

// 4.  An untimely death has come... remove our good king Robert from the array,
//     and store him in a variable named `formerKing`. Now print a hail to our
//     former king and then one to our new, and only, King Joffrey!
console.log("Number 4:");

var formerKing = kings.shift();
console.log(hailTo(formerKing));
console.log(hailTo(kings[0]));

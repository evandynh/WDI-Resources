...
You've already done a lot of conditional logic & function calling in JavaScript - it's time to translate that knowledge over to Ruby.
...
Now what if you're looking to see if something _isn't_ true? **In English, how do you tell someone to do something if a condition is not true?**
...
if delicious && !healthy
  "either eat it or shut up about it"
end
```
...
awesome = 'this cat' unless awesome
```
